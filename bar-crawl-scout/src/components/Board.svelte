...
<style>
  ...
  thead th { position: sticky; top: 114px; background: var(--field-3); color: var(--muted); font-weight: 500; font-size: 10px; letter-spacing: .06em; text-transform: uppercase; text-align: right; padding: 10px 9px; border-bottom: 1px solid var(--line); z-index: 4; white-space: nowrap; }
